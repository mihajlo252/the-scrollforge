  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center gap-5">
      ...
      <div className="flex items-center gap-1">
        ...
        {save && (
          <form className="absolute right-0 top-0 flex flex-col items-center justify-center gap-2" onSubmit={(e: any) => saveCurrentHP(e, HP)}>
            <button
              type="submit"
        ...
        <div className="relative h-[6rem] w-[6rem] overflow-hidden rounded-[100vh] border-4 border-primary">
          <div className={`h-full w-full origin-bottom bg-gradient-to-b from-[#5f0000] to-[#290a0a]`} style={{ transform: `scaleY(${scale})` }}></div>
