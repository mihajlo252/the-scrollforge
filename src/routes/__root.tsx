...
export const Route = createRootRoute({
    component: () => (
        <div className="flex h-[100svh] w-full flex-col gap-0 bg-base-300 bg-opacity-50 bg-[url('/logo-wide.png')] bg-cover bg-center bg-no-repeat px-10 pb-5 pt-2 bg-blend-overlay">
            <Navigation />
