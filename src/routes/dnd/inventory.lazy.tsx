				...
				<div className={styles.invLeft}>
					<Frame classes="card">
						<div className="card-hdr">
							<div className="card-title">Coin Purse</div>
						</div>
					...
					<Frame classes="card">
						<div className="card-hdr">
							<div className="card-title">Equipped</div>
						</div>
						<div className={styles.equippedList}>
							{equipped.length === 0 && (
								<span style={{ color: "var(--ink-faint)", fontStyle: "italic", fontSize: 13 }}>Nothing equipped</span>
							)}
							{equipped.map(({ i }) => (
					...
					<Frame classes={styles.addFrame}>
						...
						<div className={styles.formRow}>
							...
							<input
								...
								step="0.1"
								value={form.wt}
								onChange={(e) => setField("wt", parseFloat(e.target.value) || 0)}
							/>
						</div>
						<input
							className="input"
							...
							value={form.dmg ?? ""}
							onChange={(e) => setField("dmg", e.target.value)}
						/>
						<input
							className="input"
						...
						<div className={styles.formRow}>
							...
							{editIndex !== null && (
								<ConfirmButton
									...
									title="Delete item?"
									message="Remove this item from your inventory? This can't be undone."
									onConfirm={() => {
