    ...
    return (
        <motion.main className="h-full" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
            <BoxSection styles="w-full h-full flex flex-col place-self-center px-5 py-10 gap-5">
                <h1 className="text-4xl font-bold">Čin I - Trgovačka Kočija</h1>
                <section className="grid grid-cols-1">
                    <BoxSection styles="w-full h-[60vh] overflow-scroll flex flex-col text-start px-5 py-10 gap-2">
                            ...
                            <br />
                            <InstructionGM>Dodati sta god da oni kazu na sledece</InstructionGM>
                            <p>
                            ...
                            <br />
                            <p>
                                Dok vaši konji vuku kočiju kroz oštru krivinu, jedan točak se nakratko podiže od tla. Tada ugledate prevrnutu
                                trgovačku kočiju, položenu bočno preko staze, blokirajući vam prolaz. Po stazi su razbacani plodovi i povrće, delujući
                                kao da je sve ostavljeno u žurbi. Iza kočije, iz senke, izlazi strixvuk — ogromna zver sa telom vuka, licem sove i
                                velikim krilima koja mu krase leđa. Završava sa žvakanjem svog obroka — ruke mrtvog trgovca — dok vas netremice
                                posmatra, radoznao, procenjujući da li ste prijatelji... ili pretnja. Zatim, iza njega, nespretno i oprezno izlaze dva
                                mala mladunca, pažljivo promatrajući majku. Iznutra, osećate kako se kočija naglo zaustavlja. Šta želite da uradite?
                            </p>
                            <br />
                            <InstructionGM>Neka oni malo RP, a ako neko pokusa da pridje ide sledece:</InstructionGM>
                            <br />
                            <SuccessFailCrit
                                success={
                                    <>
                                        <p className="text-primary">10+ - Success</p>
                                        <ul className="list-disc pl-10">
                                            ...
                                            <li className="text-secondary">
                                                ...
                                                poziva nekog drugog Strixvuka, znate da necete biti sami zadugo
                                            </li>
                                        </ul>
                                    </>
                                }
                                fail={
                                    <>
                                        <p className="text-secondary">9- - Fail</p>
                                        <ul className="list-disc pl-10">
                                            <li className="text-primary">
                                                Hope - dobijaju Hope, malo se komplikuje jer nisu uspeli, ali ipak ne previse: Majka malo zarezi,
                                                sagne se, i mladunci joj se popnu na ledja. Ona polece i slece na obliznju granu, gledajuci i prateci
                                                vas sta radite
                                            </li>
                                            <li className="text-secondary">
                            ...
                            >
                                <p>
                                    Bacaju kockice sa Presence. Mogu da koriste Hope da dodaju neki Experience ako mogu da uklope kako bi to izgledalo
                                </p>
                            </SuccessFailCrit>
                            <Link to={"/daggerheart-demo/acts/act2"} className="btn btn-primary">Next Act</Link>
                    </BoxSection>
                </section>
            </BoxSection>
        </motion.main>
